...
abstract class CleanGenerateImageCacheDelayTask(delay: Long, delayWay: DelayWay): DelayTask(delay, delayWay) {

    constructor(delay: Long) : this(delay, DelayWay.WAIT_SPECIFIC_TIMES)

    abstract val cleanType: GenerateImageType
    ...
    // OK,这个字段就是干这个用的
//    open val isOnlyOneCanExistsBeforeTheEndOfRun: Boolean = true

    val cleanUserCacheSet: Set<UserCache> = ConcurrentHashSet()
