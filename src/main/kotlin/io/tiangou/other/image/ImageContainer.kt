...
interface ImageContainer {
    ...
    fun initBackground(bytes: ByteArray, wp: Int, hp: Int, alpha: Float = Global.drawImageConfig.background.alpha.toFloat()): ImageContainer

    fun paddingBackgroundColor(rgba: String, alpha: Float? = null): ImageContainer

    fun drawImage(bytes: ByteArray, imageWidth: Int, imageHeight: Int, left: Int = 0, top: Int = 0, alpha: Float = 1f): ImageContainer
